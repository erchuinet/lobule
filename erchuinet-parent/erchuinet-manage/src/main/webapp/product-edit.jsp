        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <section class="panel panel-padding">
                    <form id="form1" class="layui-form" data-params='{"dataName":"products","key":"id","bind":true}' action="/php/test.php">
...
<!--#include file="tpl/select-cat.html"-->
<jsp:include page="tpl/select-cat.jsp" />
<script>
    var $, JQquery;
    layui.use('product');
